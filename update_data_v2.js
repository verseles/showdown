...
const data = JSON.parse(await readFile('./data/showdown.json', 'utf8'));
...
const updates = {
	'claude-opus-4-5-20251101': {
		...
		swe_bench: 80.9,
		livebench: 76.2
		// REMOVED arc_agi_2 update here as 37.6 is for Thinking variant
	},
...
// Keep the version same as I already incremented it or increment again?
// I reverted the file so it is back to 30.
